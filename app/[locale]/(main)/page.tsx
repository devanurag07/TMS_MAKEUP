...
export default function HomeLanding() {
  ...
  return (
    <div className="h-full bg-black text-white flex flex-col items-center justify-between px-6 py-10 relative">
      {/* Logout */}
      ...
      {/* Tagline 2 */}
      <p className="mt-8 text-6xl sm:text-5xl md:text-6xl italic font-semibold text-center">
        {t("landing.welcome")}
      </p>
      ...
      <div className="w-full flex justify-center mt-10">
        <Link
          href="/home"
          className="inline-flex items-center justify-center bg-white text-black rounded-2xl !px-24 sm:px-10 py-8 text-4xl sm:text-5xl font-semibold shadow-[0_0_0_2px_rgba(255,255,255,0.2)_inset] hover:opacity-90 transition"
        >
